...
export const i18n = createI18n({
  ...
  messages: {
    de: { ...deHome, ...deFooter, ...deHeader, ...deNfts, ...deNft, ...deAdmin, ...deMeta, ...dePrivacy, ...deImprint },
    en: { ...enHome, ...enFooter, ...enHeader, ...enNfts, ...enNft, ...enAdmin, ...enMeta, ...enPrivacy, ...enImprint },
  },
})
