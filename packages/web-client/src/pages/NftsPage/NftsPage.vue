<template>
  <div class="nfts-page">
    ...
    <main class="nfts-page__main">
      ...
      <!-- Empty -->
      <section
        v-if="!isLoading && !isError && tokens.length === 0"
        ...
        >
          ...
          <div class="card__meta">
            ...
            <div class="card__links">
              ...
              <a
                :href="
                  `${explorerBase}/token/${erc721Address}?a=${tkn.tokenId}`
                "
                target="_blank"
                rel="noopener"
                class="link"
